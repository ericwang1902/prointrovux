    ...
    <div>
        <group title="产品目录">
            ...
            <template class="slide" :class="showContent001?'animate':''" v-if="showContent001">
                <cell-box :border-intent="false" class="sub-item" is-link>个人</cell-box>
                <cell-box class="sub-item" is-link>企业</cell-box>
            </template>
            ...
            <template class="slide" :class="showContent003?'animate':''" v-if="showContent003">
                <cell-box :border-intent="false" class="sub-item" is-link>代缴类</cell-box>
                <cell-box class="sub-item" is-link>贵金属</cell-box>
            </template>
